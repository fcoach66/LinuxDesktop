...
echo "background-color='#000000'" >> /usr/share/glib-2.0/schemas/20_sinfocom-unity-greeter.gschema.override
echo "background='/usr/share/themes/ChaletOSRes/splash.png'" >> /usr/share/glib-2.0/schemas/20_sinfocom-unity-greeter.gschema.override
...
echo "theme-name='Greybird_W8'" >> /usr/share/glib-2.0/schemas/20_sinfocom-unity-greeter.gschema.override
echo "icon-theme-name='ChaletOS Emerald'" >> /usr/share/glib-2.0/schemas/20_sinfocom-unity-greeter.gschema.override
echo "font-name='Droid Sans 9'" >> /usr/share/glib-2.0/schemas/20_sinfocom-unity-greeter.gschema.override
echo "xft-antialias=true" >> /usr/share/glib-2.0/schemas/20_sinfocom-unity-greeter.gschema.override
echo "xft-dpi=96" >> /usr/share/glib-2.0/schemas/20_sinfocom-unity-greeter.gschema.override
echo "xft-hintstyle='hintnone'" >> /usr/share/glib-2.0/schemas/20_sinfocom-unity-greeter.gschema.override
echo "xft-rgba='rgb'" >> /usr/share/glib-2.0/schemas/20_sinfocom-unity-greeter.gschema.override
